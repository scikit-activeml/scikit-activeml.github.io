...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml.github.io/blob/gh-pages/development/generated/sphinx_gallery_notebooks//1-pool-classification/plot-SubSamplingWrapper-Sub-sampling_Wrapper.ipynb
#
...
qs = SubSamplingWrapper(
    query_strategy=UncertaintySampling(), max_candidates=0.5
)
