...
# %%
# **Idea:** FALCUN selects a batch directly in probability space using a self-adjusting mix of uncertainty and diversity. By operating only on low-dimensional softmax outputs rather than deep embeddings, it achieves fast acquisitions while retaining strong label efficiency.
...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml.github.io/blob/gh-pages/development/generated/sphinx_gallery_notebooks//1-pool-classification/plot-Falcun-Fast_Active_Learning_by_Contrastive_UNcertainty_(FALCUN).ipynb
#
