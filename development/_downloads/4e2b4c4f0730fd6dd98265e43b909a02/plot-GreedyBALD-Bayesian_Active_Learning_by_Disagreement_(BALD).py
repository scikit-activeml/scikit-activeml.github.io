...
# %%
# **Idea:** BALD reduces the number of possible hypotheses maximally fast to minimize the uncertainty about the parameters using Shannon's entropy. It seeks the data point that maximises the decrease in expected posterior entropy. For the batch case, a greedy (top-k) selection is applied.
...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml.github.io/blob/gh-pages/development/generated/sphinx_gallery_notebooks//1-pool-classification/plot-GreedyBALD-Bayesian_Active_Learning_by_Disagreement_(BALD).ipynb
#
...
for c in range(n_cycles):
    ...
    ax = plot_utilities(
        ...
        ensemble=clf,
        replace_nan=None,
        candidates=X[unlabeled_indices(y)],
        res=25,
