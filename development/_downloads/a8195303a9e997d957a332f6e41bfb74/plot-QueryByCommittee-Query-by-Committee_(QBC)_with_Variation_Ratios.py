...
# %%
# **Idea:** QBC maintains a committee of models and selects unlabeled samples where the committee most disagrees, targeting epistemic uncertainty. In batch mode, it ranks points by a disagreement score and takes the top `batch_size` samples. Variation ratios (classification) means that one minus the fraction of votes for the modal class measures lack of consensus, and higher values are preferred.
...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml.github.io/blob/gh-pages/development/generated/sphinx_gallery_notebooks//1-pool-classification/plot-QueryByCommittee-Query-by-Committee_(QBC)_with_Variation_Ratios.ipynb
#
...
qs = QueryByCommittee(
    method="variation_ratios",
    sample_predictions_method_name="sample_proba",
    sample_predictions_dict={"n_samples": 100},
)
