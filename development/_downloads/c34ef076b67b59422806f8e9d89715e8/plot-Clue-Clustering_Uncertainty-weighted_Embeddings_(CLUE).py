...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml.github.io/blob/gh-pages/development/generated/sphinx_gallery_notebooks//1-pool-classification/plot-Clue-Clustering_Uncertainty-weighted_Embeddings_(CLUE).ipynb
#
...
for c in range(n_cycles):
    ...
    query_idx, utilities = qs.query(
        X=X, y=y, estimator=clf, batch_size=4, return_utilities=True
    )
