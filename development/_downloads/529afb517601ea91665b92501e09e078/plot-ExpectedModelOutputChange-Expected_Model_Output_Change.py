...
# %%
# **Idea:** Expected Model Output Change queries those samples that change the output of the regression model the most. The difference in output is measured by the loss function `self.loss`.
...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml.github.io/blob/gh-pages/development/generated/sphinx_gallery_notebooks//2-pool-regression/plot-ExpectedModelOutputChange-Expected_Model_Output_Change.ipynb
#
