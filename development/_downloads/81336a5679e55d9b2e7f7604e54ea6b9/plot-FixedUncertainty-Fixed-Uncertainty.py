...
# %%
# **Idea:** The Fixed-Uncertainty query strategy queries samples based on the classifiers uncertainty that is assessed based on the classifier's predictions. The sample is queried when the probability of the most likely class exceeds a threshold calculated based on the budget and the number of classes.
...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml.github.io/blob/gh-pages/development/generated/sphinx_gallery_notebooks//4-stream/plot-FixedUncertainty-Fixed-Uncertainty.ipynb
#
