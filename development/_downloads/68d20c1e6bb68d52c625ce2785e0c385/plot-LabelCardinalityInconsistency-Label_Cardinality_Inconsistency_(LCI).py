...
# %%
# **Idea:** LCI queries samples whose predicted number of positive labels differs most from the mean label cardinality of the labeled pool.
...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml.github.io/blob/gh-pages/development/generated/sphinx_gallery_notebooks//1-pool-classification/plot-LabelCardinalityInconsistency-Label_Cardinality_Inconsistency_(LCI).ipynb
#
...
# .. rubric:: References:
#
# The implementation of this strategy is based on :footcite:t:`wang2019multi`.
#
# .. footbibliography::
