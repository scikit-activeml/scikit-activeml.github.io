...
# %%
# **Idea:** USAP selects samples with the highest expected improvement in average precision under the model's current predictions.
...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml.github.io/blob/gh-pages/development/generated/sphinx_gallery_notebooks//1-pool-classification/plot-UncertaintySampling-Uncertainty_Sampling_with_Expected_Average_Precision_(USAP).ipynb
#
