...
# %%
# **Idea:** Probabilistic Active Learning in Datastreams is an extension to Multi-Class Probabilistic Active Learning (McPAL) (see `pool.ProbabilisticAL`). It uses McPAL to assess the spatial utility. The Balanced Incremental Quantile Filter (`BalancedIncrementalQuantileFilter`), that is implemented within the default budget manager, is used to evaluate the temporal utility.
...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml.github.io/blob/gh-pages/development/generated/sphinx_gallery_notebooks//4-stream/plot-StreamProbabilisticAL-Probabilistic_Active_Learning_in_Datastreams.ipynb
#
