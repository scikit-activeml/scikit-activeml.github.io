...
# %%
# **Idea:** MaxHerding greedily selects `batch_size` unlabeled samples that most increase a smooth, kernel-based coverage objective in embedding space, accounting for the already labeled set. The objective promotes representativeness and diversity via kernel similarity.
...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml.github.io/blob/gh-pages/development/generated/sphinx_gallery_notebooks//1-pool-classification/plot-MaxHerding-MaxHerding.ipynb
#
...
qs = MaxHerding(normalize_samples=False)
...
# .. rubric:: References:
#
# The implementation of this strategy is based on :footcite:t:`bae2024generalized`.
#
# .. footbibliography::
