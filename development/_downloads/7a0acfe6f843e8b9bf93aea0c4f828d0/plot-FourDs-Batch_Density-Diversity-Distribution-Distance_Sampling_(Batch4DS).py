...
# %%
# **Idea:** 4DS combines four criteria computed from a generative mixture-model classifier: distance to the decision boundary (uncertainty), density of the sample's region (representativeness), diversity within the batch (non-redundancy), and class-distribution balancing. It selects a batch by greedily maximizing a weighted sum of these scores with automatically adapted weights, yielding uncertain, representative, and non-redundant queries.
...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml.github.io/blob/gh-pages/development/generated/sphinx_gallery_notebooks//1-pool-classification/plot-FourDs-Batch_Density-Diversity-Distribution-Distance_Sampling_(Batch4DS).ipynb
#
...
clf = MixtureModelClassifier(
    classes=[0, 1], mixture_model=GaussianMixture(n_components=5)
)
