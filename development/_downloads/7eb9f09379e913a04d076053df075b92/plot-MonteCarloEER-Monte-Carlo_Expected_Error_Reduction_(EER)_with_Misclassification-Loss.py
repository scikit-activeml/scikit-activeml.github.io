...
# %%
# EER selects the unlabeled sample whose label, in expectation, would most reduce future misclassification rate after retraining. In practice it approximates this one-step lookahead with Monte Carlo over possible labels, but it is computationally heavy and sensitive to calibration of class probabilities.
...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml.github.io/blob/gh-pages/development/generated/sphinx_gallery_notebooks//1-pool-classification/plot-MonteCarloEER-Monte-Carlo_Expected_Error_Reduction_(EER)_with_Misclassification-Loss.ipynb
#
