...
# %%
# **Idea:** VOI treats querying as a decision problem and picks the sample with the highest expected information gain minus its cost, using a one-step lookahead over possible outcomes.
...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml.github.io/blob/gh-pages/development/generated/sphinx_gallery_notebooks//1-pool-classification/plot-ValueOfInformationEER-Value_of_Information_(VOI)_on_Unlabeled_Samples.ipynb
#
