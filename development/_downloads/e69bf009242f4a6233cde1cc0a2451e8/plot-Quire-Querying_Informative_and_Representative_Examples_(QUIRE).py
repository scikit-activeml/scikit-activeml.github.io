...
# %%
# **Idea:** QUIRE uses the min–max view of active learning with a regularized least-squares classifier in a reproducing kernel Hilbert space (RKHS) under quadratic loss. It assigns each unlabeled sample a single score derived from the kernel ridge regression objective that jointly reflects informativeness with respect to the labeled set and representativeness with respect to the unlabeled set.
...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml.github.io/blob/gh-pages/development/generated/sphinx_gallery_notebooks//1-pool-classification/plot-Quire-Querying_Informative_and_Representative_Examples_(QUIRE).ipynb
#
