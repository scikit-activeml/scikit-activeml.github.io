...
# %%
# **Idea:** The Variable-Uncertainty query strategy queries labels based on the classifiers uncertainty assessed based on the classifier's predictions. The sample is queried when the probability of the most likely class exceeds a time-dependent threshold calculated based on the budget, number of observed and acquired samples.
...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml.github.io/blob/gh-pages/development/generated/sphinx_gallery_notebooks//4-stream/plot-VariableUncertainty-Variable-Uncertainty.ipynb
#
