...
# %%
# **Idea:** Expected Model Change chooses those samples that have a maximal expected gradient length with respect to the model parameters. While designed for a linear regressor the formulas obtained from the linear case can be applied to arbitrary regressors.
...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml.github.io/blob/gh-pages/development/generated/sphinx_gallery_notebooks//2-pool-regression/plot-ExpectedModelChangeMaximization-Expected_Model_Change.ipynb
#
