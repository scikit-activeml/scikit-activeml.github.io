...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml.github.io/blob/gh-pages/development/generated/sphinx_gallery_notebooks//1-pool-classification/plot-ParallelUtilityEstimationWrapper-Parallel_Utility_Estimation_Wrapper.ipynb
#
...
qs = ParallelUtilityEstimationWrapper(
    query_strategy=ProbabilisticAL(), n_jobs=4
)
