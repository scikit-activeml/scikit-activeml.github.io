...
# %%
# **Idea:** DWUS ranks each unlabeled sample by its uncertainty multiplied by a representativeness score estimated from the pool (for example, average similarity or k-NN density), then selects the highest scorers.
...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml.github.io/blob/gh-pages/development/generated/sphinx_gallery_notebooks//1-pool-classification/plot-UncertaintySampling-Density-weighted_Uncertainty_Sampling_(DWUS).ipynb
#
