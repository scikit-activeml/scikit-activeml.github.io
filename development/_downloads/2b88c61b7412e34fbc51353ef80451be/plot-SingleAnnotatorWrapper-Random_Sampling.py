...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml.github.io/blob/gh-pages/development/generated/sphinx_gallery_notebooks//3-pool-multi-annotator/plot-SingleAnnotatorWrapper-Random_Sampling.ipynb
#
...
qs = SingleAnnotatorWrapper(
    strategy=RandomSampling(random_state=random_state),
    random_state=random_state,
)
