...
# %%
# **Idea:** CoreSet applies a k-center (farthest-first) selection in an embedding space, seeded by the labeled set, to minimize the maximum distance of unlabeled samples to the labeled/selected samples. It is a pure diversity criterion without explicit consideration of prediction uncertainty.
...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml.github.io/blob/gh-pages/development/generated/sphinx_gallery_notebooks//1-pool-classification/plot-CoreSet-Core_Set.ipynb
#
