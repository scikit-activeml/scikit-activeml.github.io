...
# %%
# **Idea:** Random sampling is a lower baseline for other query strategies. It randomly selects `batch_size` unlabeled samples whose utility scores are also randomly generated.
...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml.github.io/blob/gh-pages/development/generated/sphinx_gallery_notebooks//1-pool-classification/plot-RandomSampling-Random_Sampling.ipynb
#
