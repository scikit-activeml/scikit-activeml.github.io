...
# %%
# **Idea:** distinguishes epistemic from aleatoric uncertainty and queries samples with maximal epistemic uncertainty, meaning predictions vary most across models that are well-supported by the current data. It implements this via relative-likelihood based degrees of support and provides instantiations for Parzen windows, decision trees, and logistic regression. The current implementation only supports binary classification tasks and the following classifiers:
#
...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml.github.io/blob/gh-pages/development/generated/sphinx_gallery_notebooks//1-pool-classification/plot-EpistemicUncertaintySampling-Epistemic_Uncertainty_Sampling_(EpisUS).ipynb
#
