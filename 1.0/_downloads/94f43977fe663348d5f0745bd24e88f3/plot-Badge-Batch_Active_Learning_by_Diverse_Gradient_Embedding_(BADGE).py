...
#    :target: https://colab.research.google.com/github/scikit-activeml/scikit-activeml.github.io/blob/gh-pages/1.0/generated/sphinx_gallery_notebooks//1-pool-classification/plot-Badge-Batch_Active_Learning_by_Diverse_Gradient_Embedding_(BADGE).ipynb
#
